...
/*   Updated: 2025/09/05 09:08:46 by eganassi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//bool apply_redir(char ***arg, int *i, t_arr *oper)
//{
//    char **expanded = *arg;
...
//char *expansion_partition_redirection(char *in, t_list *env, t_arr *oper)
//{
//    char *in = expand_variables(in,env);
//    //while(expanded[i])
//    //{
