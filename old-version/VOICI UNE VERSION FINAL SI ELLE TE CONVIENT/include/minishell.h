...
/*   Updated: 2025/09/08 14:24:05 by nkiefer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_rtype						type;
	char *arg;   /* filename or delimiter without quotes */
	char *raw;   /* original token with quotes */
	bool quoted; /* original token contained quotes */
	int hfd;     /* precomputed heredoc fd */
}								t_redir;
...
// void    file_access_redirection(t_shell *shell, void **arr, int t_arr_index,
	int i);
	...
	// void    child_exec_maillon(t_cmd *c, t_shell *sh, int i, int ncmd,
	int p[][2]);
