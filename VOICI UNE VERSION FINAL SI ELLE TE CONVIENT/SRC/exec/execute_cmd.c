...
/*   Updated: 2025/09/08 12:28:15 by nkiefer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Hypothèses :
** - prepare_or_run_builtin(shell, cmd,
	&args) : prépare args ou exécute le builtin et ne revient pas.
** - find_command_path, list_to_envp, free_str_array, cmd_not_found,
	exit_child_process existent.
**
	- shell->exec_cmd_path_tmp et shell->exec_envp_tmp sont 
    utilisés ailleurs (pour cleanup si exec échoue).
*/
